...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		new Album(title: "Alexander", artist: "Alexander", cover: new URI("/images/albums/album-02.jpg"), tracks: ["Let's Win!", "Awake My Body", "Truth", "In The Twilight", "Bad Bad Love", "Old Friend", "A Million Years", "Remember Our Heart", "Glimpses", "Let's Make A Deal Not To Make A Deal"]).save(failOnError: true)
		new Album(title: "Another Man's Treasure", artist: "Ima Robot", cover: new URI("/images/albums/album-03.jpg"), tracks: ["INtro", "Ruthless", "Rough Night", "Life is Short", "Sail With Me", "Pass It On", "Shine Shine", "Swell", "Greenback Boogie", "Victory", "Peru", "Life is Short (extended ice cream truck edit)"]).save(failOnError: true)
		new Album(title: "The King Is Dead", artist: "The Decemberists", cover: new URI("/images/albums/album-04.jpg"), tracks: ["Don't Carry It All", "Calamity Song", "Rise To Me", "Rox In The Box", "January Hymn", "Down By The Water", "All Arise!", "June Hymn", "This Is Why We Fight", "Dear Avery"]).save(failOnError: true)
		new Album(title: "Helplessness Blues", artist: "Fleet Foxes", cover: new URI("/images/albums/album-05.jpg"), tracks: ["Montezuma", "Bedouin Dress", "Sim Sala Bim", "Battery Kinzie", "The Plains / Bitter Dancer", "Helplessness Blues", "The Cascades", "Lorelai", "Someone You'd Admire", "The Shrine / An Argument", "Blue Spotted Tail", "Grown Ocean"]).save(failOnError: true)
